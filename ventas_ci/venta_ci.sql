...
CREATE TABLE IF NOT EXISTS `ventas_ci`.`productos` (
  ...
  UNIQUE INDEX `nombre_UNIQUE` (`nombre` ASC) VISIBLE,
  INDEX `fk_categoria_producto_idx` (`id_categoria` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ventas_ci`.`clientes` (
  ...
  UNIQUE INDEX `empresa_UNIQUE` (`empresa` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ventas_ci`.`usuarios` (
  ...
  INDEX `fk_rol_usuarios_idx` (`id_rol` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ventas_ci`.`ventas` (
  ...
  INDEX `fk_usuario_venta_idx` (`id_usuario` ASC) VISIBLE,
  INDEX `fk_cliente_venta_idx` (`id_cliente` ASC) VISIBLE,
  INDEX `fk_tipo_documento_venta_idx` (`id_tipo_documento` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `ventas_ci`.`detalle_venta` (
  ...
  INDEX `fk_venta_detalle_idx` (`id_venta` ASC) VISIBLE,
  INDEX `fk_prodcuto_detalle_idx` (`id_producto` ASC) VISIBLE,
